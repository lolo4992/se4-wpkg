<?php
/**
 * accueil de la section mise en forme
 * @Version $Id$
 * @Projet LCS / SambaEdu
...
*/
	...
	echo "<br><table cellspadding='2' cellspacing='1' border='0' align='center' bgcolor='black'>\n";
	echo "<tr>";
	echo "<th style='color:white' width='700' height='40' valign='center'>Mise en forme actuelle</th>";
	echo "</tr>\n";
	echo "</table><br>\n";
	...
	echo "<br><table cellspadding='2' cellspacing='1' border='0' align='center' bgcolor='black'>\n";
	echo "<tr>";
	echo "<th style='color:white' width='700' height='40' valign='center'>Mise en forme par défaut</th>";
	echo "</tr>\n";
	echo "</table><br>\n";
	...
	echo "<br><table cellspadding='2' cellspacing='1' border='0' align='center' bgcolor='black'>\n";
	echo "<tr>";
	echo "<th style='color:white' width='700' height='40' valign='center'>Mise en forme personnalisée</th>";
	echo "</tr>\n";
	echo "</table><br>\n";
