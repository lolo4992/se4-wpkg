...
*/
	...
	echo "<tr>\n";
		...
		echo "<a href='poste_maintenance_app.php?tri2=".$tri2."&id_host=".$id_host."&ok=".$get_ok."&warning=".$get_warning."&error=".$get_error."'>Choix des applications &#224; d&#233;ployer sur le poste uniquement</a>";
		echo "</td>\n";
	echo "</tr>\n";
	echo "<tr>\n";
		echo "<td align='center'>";
		echo "<a href='poste_maintenance_options.php?tri2=".$tri2."&id_host=".$id_host."&ok=".$get_ok."&warning=".$get_warning."&error=".$get_error."'>D&#233;finir la valeur des options pass&#233;es au client wpkg</a>";
		echo "</td>\n";
	echo "</tr>\n";
	echo "</table>\n";
